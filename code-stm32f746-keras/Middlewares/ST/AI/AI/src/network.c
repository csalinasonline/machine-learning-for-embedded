...
#define AI_NETWORK_MODEL_SIGNATURE     "b8efcc17edcc2157a7cfbcb03a2d97b1"
...
#define AI_TOOLS_DATE_TIME   "Tue Jul  2 12:27:51 2019"
...
AI_TENSOR_OBJ_DECLARE(
  ...
  AI_STRIDE_INIT(147456, 147456, 2304, 4),
  ...
  ai_network* net_ctx, const ai_buffer* activation_buffer)
{
  ...
  conv2d_2_output_array.data = activations + 21760;
  conv2d_2_output_array.data_start = activations + 21760;
  ...
  dense_1_output_array.data = activations + 2304;
  dense_1_output_array.data_start = activations + 2304;
  dense_1_nl_output_array.data = activations + 2304;
  dense_1_nl_output_array.data_start = activations + 2304;
  ...
  ai_network* net_ctx, const ai_buffer* weights_buffer)
{
  ...
  conv2d_3_weights_array.data = weights + 75264;
  conv2d_3_weights_array.data_start = weights + 75264;
  conv2d_3_bias_array.format |= AI_FMT_FLAG_CONST;
  conv2d_3_bias_array.data = weights + 222720;
  conv2d_3_bias_array.data_start = weights + 222720;
  dense_1_weights_array.format |= AI_FMT_FLAG_CONST;
  dense_1_weights_array.data = weights + 222976;
  dense_1_weights_array.data_start = weights + 222976;
  dense_1_bias_array.format |= AI_FMT_FLAG_CONST;
  dense_1_bias_array.data = weights + 370432;
  dense_1_bias_array.data_start = weights + 370432;
  dense_2_weights_array.format |= AI_FMT_FLAG_CONST;
  dense_2_weights_array.data = weights + 370688;
  dense_2_weights_array.data_start = weights + 370688;
  dense_2_bias_array.format |= AI_FMT_FLAG_CONST;
  dense_2_bias_array.data = weights + 373248;
  dense_2_bias_array.data_start = weights + 373248;
