...
#define AI_NETWORK_MODEL_SIGNATURE     "de372f95ced26870922986fcec9921ee"
...
#define AI_TOOLS_DATE_TIME   "Mon Jul  1 16:54:39 2019"
...
AI_TENSOR_OBJ_DECLARE(
  dense_2_weights,
  AI_SHAPE_INIT(1, 1, 32, 16),
  AI_STRIDE_INIT(512, 512, 16, 1),
...
AI_TENSOR_OBJ_DECLARE(
  dense_3_weights,
  AI_SHAPE_INIT(1, 1, 2, 32),
  AI_STRIDE_INIT(256, 256, 128, 4),
  ...
  ai_network* net_ctx, const ai_buffer* weights_buffer)
{
  ...
  dense_2_weights_array.data = weights + 128;
  dense_2_weights_array.data_start = weights + 640;
  dense_2_bias_array.format |= AI_FMT_FLAG_CONST;
  dense_2_bias_array.data = weights + 1664;
  dense_2_bias_array.data_start = weights + 1664;
  dense_3_weights_array.format |= AI_FMT_FLAG_CONST;
  dense_3_weights_array.data = weights + 1792;
  dense_3_weights_array.data_start = weights + 1792;
  dense_3_bias_array.format |= AI_FMT_FLAG_CONST;
  dense_3_bias_array.data = weights + 2048;
  dense_3_bias_array.data_start = weights + 2048;
